...
def merge_groups(idx1, idx2):
  ...
  # Merge smaller into larger (optional optimization)
...
print(lengths)
product = heapq.heappop(lengths) * heapq.heappop(lengths) * heapq.heappop(lengths)
print(groups)
print(abs(product)) # WAAAAH ACCEPTED 